...
namespace LG.Web.ViewModels.Post
{
    public class EditorBorrador
    {
        ...
        public EditorBorrador(global::Blog.Modelo.Posts.Post post): this()
        {
        ...
        private void AñadirPostsRelacionados(global::Blog.Modelo.Posts.Post post)
        {
        ...
        private void AñadirUtensilios(global::Blog.Modelo.Posts.Post post)
        {
