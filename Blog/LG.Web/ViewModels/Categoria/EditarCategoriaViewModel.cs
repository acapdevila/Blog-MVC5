...
namespace LG.Web.ViewModels.Categoria
{
    ...
    {
        public EditarCategoriaViewModel() : this(new global::Blog.Modelo.Categorias.Categoria())
        {
            
        }

        public EditarCategoriaViewModel(global::Blog.Modelo.Categorias.Categoria categoria)
        {
            Id = categoria.Id;
